/*
  ...
  program is to demonstrate some of the basic OpenGL commands.

  To compile on unix/linux:  g++ bubbles.cpp -lglut -lGLU

  User interaction: 
  * left mouse click: fire laser
  * right mouse click and drag: rotate view of the world
  * + and -: move forward/backward in the world
  * left/right/up/down arrows: move in the world
  * r: reset your position in the world to what it was when the 
       program started
  * 2: add more bubbles to the screen, (roughly double)
  * after "popping" all the bubbles, twice as many new ones will appear
  * bubbles automatically disappear when they get too far away and 
    reappear closer again.
*/

// **** SUGGESTION ****
// If you are reading this file for the first time, skip ahead to 
// look at the main function since that is where the program starts.
// Then look back at other functions as you see them called.

// **** NOTE ****
// The game will run at different speeds on different computers.  I have
// not put in the logic to make it run at the same speed no matter which
// computer it is on.


// by including glut.h, OpenGL, glut, and GLU functions will be 
// available.
#include <GL/glut.h>
